...
# Upload endpoint (optional, for uploads via API)
...
# Example route: Generate TTS audio
...
# Example route: Transcribe audio with Whisper
...
# Example route: Download YouTube video audio
...
# Example route: Run FFmpeg command (simple test)
...
if __name__ == "__main__":
    app.run(host="0.0.0.0", port=3000)from flask import Flask, request, jsonify, send_file
import os
import re
from gtts import gTTS
import whisper
